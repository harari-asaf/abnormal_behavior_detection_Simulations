# Main program for avoidance class
...
def main():
    ...
    update_cycle_time = 0.28 / sim_time_factor
    ...
    for i in range(num_of_iter):
        ...
        scenario = Avoidance(client, drones, initial_positions, malicious, anomaly_type, sim_time_factor)
        ...
        while not has_ended:
            ...
            if time_from_beginning > time_till_anomaly and anomaly_type != "none" and not is_anomaly:
                ...
                # Remove the malicious drone from the regular drones' list
                scenario.remove_mal_drones(malicious)
