...
def main():
    ...
    for i in range(num_of_iter):
        ...
        initial_positions = np.array([[2, 0, -2], [4, 0, -2], [2, 2, -2], [4, 2, -2], [6, 0, -2]])
        ...
        scenario = Survey(client, drones, initial_positions, malicious, anomaly_type, sim_time_factor)
