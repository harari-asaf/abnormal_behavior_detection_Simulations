# Main program for follow path class
...
def main():
  ...
  for i in range(num_of_iter):
    ...
    # Creating the followpath scenario class
    scenario = FollowPath(client, drones, initial_positions, malicious, anomaly_type, sim_time_factor)
